import { SimpleGrid,Button, Text, TextInput, ActionIcon } from '@mantine/core';
...
function Footer() {
    ...
    return ( 
            <SimpleGrid cols={3} style={{bottom:0,left:0,width:'100%', height:'200px', backgroundColor:'#000000', marginTop:'100px'}} position="center">

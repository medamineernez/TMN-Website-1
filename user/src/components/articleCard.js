    ...
    return ( 
        <div>
             <MediaQuery largerThan="xs" styles={hide}>
                <Card style={{ width: "600px", height: "350px" }} shadow="sm" padding="xl" component={Link} to={"/" + props.category+ "/" +props.id}>
                    <Card.Section>
                    ...
                    <Text size="sm" lineClamp={3}>{props.description}</Text>
                </Card>
             </MediaQuery>

             <MediaQuery smallerThan="xs" styles={hide}>
                 <Card style={{ width: "400px", height: "300px" }} shadow="sm" padding="xl" component={Link} to={"/" + props.category+ "/" +props.id}>
                    <Card.Section>
